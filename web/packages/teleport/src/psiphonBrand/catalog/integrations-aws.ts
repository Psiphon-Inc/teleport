...
export const INTEGRATIONS_AWS_BASELINE: readonly BrandBaselineEntry[] = [
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/tf_module.ts',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Azure/tf_module.ts',
  },
  {
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/DeploymentMethodSection.tsx',
  },
  {
    source: '2. Configure Azure and Teleport providers',
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Azure/ApplyTerraformSection.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsConsole/IamIntegration/IamIntegration.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/EnrollAws.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Azure/InfoGuide.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Azure/EnrollAzure.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/Details/Rules.tsx',
  },
  {
    source: 'Enroll Azure resources into Teleport.',
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/services/integrations/integrations.ts',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 2,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/DeploymentMethodSection.tsx, teleport/src/Integrations/Enroll/Cloud/Azure/ApplyTerraformSection.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsConsole/Access/Access.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/guides/RdsGuide.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsOidc/AwsOidc.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/guides/Ec2Guide.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/ResourcesSection.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsConsole/Access/ProfilesTable.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/shared/RoleArnInput.tsx',
  },
  {
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/Details/Agents.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/IntegrationTiles/integrations.ts',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/common.tsx',
  },
  {
  ...
  },
  {
    ...
    count: 2,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/Cards/ConsoleCard.tsx, teleport/src/services/integrations/integrations.ts',
  },
  {
    source: 'Sync IAM Profiles with Teleport as Resources',
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsConsole/Access/Profiles.tsx',
  },
  {
    source: 'Teleport AWS Console and CLI access: Set up access',
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsConsole/Guide.tsx',
  },
  {
    source: 'Teleport AWS Discovery Documentation',
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/InfoGuide.tsx',
  },
  {
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/fixtures.ts',
  },
  {
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/guides/DashboardGuide.tsx',
  },
  {
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/status/AwsOidc/guides/EksGuide.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 2,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/Cloud/Aws/InfoGuide.tsx, teleport/src/Integrations/Enroll/Cloud/Azure/InfoGuide.tsx',
  },
  {
    source:
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/DeleteAwsOidcIntegrationDialog.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/IntegrationTiles/IntegrationTiles.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/shared/ShowConfigurationScript.tsx',
  },
  {
    source:
  ...
  },
  {
    ...
    count: 1,
    reason:
      'Not yet authored. Upstream wording reaches a user from teleport/src/Integrations/Enroll/AwsOidc/ConfigureAwsOidcSummary.tsx',
  },
];
