...
|---|---|---|
| [`design/2026-08-17-theme-token-mapping.md`](design/2026-08-17-theme-token-mapping.md) | Design | **Partial.** The theme contract. 16 of 21 role groups decided, 94 of 174 tokens, each with a measured contrast ratio. The implementations follow it and add nothing to it. |
